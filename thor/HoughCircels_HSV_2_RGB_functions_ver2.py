...
all_pos_valid_oldpos_x=Discard_if_too_far_from_old_pos(all_pos=all_pos_x,oldpos=676,thres_oldpos=50)
all_pos_valid_oldpos_y=Discard_if_too_far_from_old_pos(all_pos=all_pos_y,oldpos=720,thres_oldpos=50)
...
lav et plot på bilelde med alle de muligede position og så avg_pos_x_final
"""
